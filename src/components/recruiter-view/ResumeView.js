            ...
            <div className="w-100 d-flex" >
                ...
                <div className="resumeViewRightPanel">
                    ...
                    <div className="resumeViewDropDowns">
                        ...
                        <RecruiterViewDropDown text="Frameworks and Tools" items={frameWorks} hasSearch={true} />
                        <RecruiterViewDropDown text="Database Systems" items={databaseSystems} hasSearch={true} />
                        <RecruiterViewDropDown text="Programming Languages" items={programmingLanguages} hasSearch={true} />
